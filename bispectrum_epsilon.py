...
#bispectra_cpt_odd = calculator_bispectrum.calculator_bispectrum('T ', 'odd', alpha_bar, Caa_01, CEa_01, CTa_01, CEE, CTE, lmax_alpha, lmax_start, lmax_bis, lmax_computed_cl)
bispectra_cpt_odd = calculator_bispectrum.calculator_bispectrum('T ', 'odd', alpha_bar, Caa_001, CEa_001, CTa_001, CEE, CTE, lmax_alpha, lmax_start, lmax_bis, lmax_computed_cl)
