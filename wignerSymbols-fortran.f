...
C**     +      'integer.',IER,1)
         PRINT*, 'L2+L3+L5+L6 or L4+L2+L6 not integer.'
         RETURN
...
C**     +      'condition not satisfied.',IER,1)
         PRINT*, 'L4, L2, L6 triangular condition not satisfied.s'
         RETURN
...
C**     +      'condition not satisfied.',IER,1)
         PRINT*, 'L4, L5, L3 triangular condition not satisfied.'
         RETURN
      ENDIF
C
C  Limits for L1
...
C**     +            'coefficients too small.',IER,1)
      PRINT*, 'Dimension of result array for 6j coefficients too small.'
      RETURN
C
C
